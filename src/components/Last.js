        ...
        <div className="row d-flex justify-content-center">
          <div className="col-md-6 col-sm-12 py-3 d-flex justify-content-center order-md-2 order-1">
            <div data-aos="fade-up">
              <h1 className="my-4 heading">What are the Symptoms?</h1>
          ...
          <div className="col-md-6 col-8 order-2 order-md-1 d-flex align-items-center">
            <div data-aos="fade-right">
              <img src={symptoms} alt="symptoms_img" className="img-fluid" />
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="row bg-light">
            <div className="col-md-6">
              ...
              <div className="row precautions p-3 d-sm-flex justify-content-center align-items-center justify-content-sm-between">
                ...
                />
                <div className="col-sm-12 content col-lg-8 my-sm-3 col-12">
                  <h5>Cover Face When Coughing or Sneezing</h5>
                  <p>
                    Cover your mouth/nose with a tissue or sleeve when coughing
                    or sneezing
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="row precautions p-3 d-sm-flex justify-content-center align-items-center justify-content-sm-between">
                ...
                <div className="col-sm-12 content col-lg-8 my-sm-3 col-12">
                  ...
                  <p>
                    Ignore to move outdoors, try to keep yourself self
                    quarantine.
                  </p>
                </div>
              </div>
              <div className="row precautions p-3 d-sm-flex justify-content-center align-items-center justify-content-sm-between">
                ...
                <div className="col-sm-12 content col-lg-8 my-sm-3 col-12">
                  ...
                  <p>
                    Do hesitate to take medical health and support in case you
                    feel unwell or finds symptoms of Covid-19
                  </p>
                </div>
              </div>
              <div className="row precautions p-3 d-sm-flex justify-content-center align-items-center justify-content-sm-between">
                ...
                <div className="col-sm-12 content col-lg-8 my-sm-3 col-12">
                  ...
                  <p>
                    ...
                    sneezing. Keep minimum 6 feet distance
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="container-fluid" id="needs_help">
        <div data-aos="zoom-in" data-aos-duration="300">
          <div className="shadow main-jumbotron jumbotron my-0 py-3">
            ...
            >
              If you find symptoms of COVID-19, Do not hesitate... Call Right
              Now
            </h4>
